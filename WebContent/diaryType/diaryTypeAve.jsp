...
<body>
	<div class="data_list">
		...
		<form action="${pageContext.request.contextPath}/diaryType_save.action" method="post" onsubmit="return checkForm()">
			<div class="diaryType_form">
			<input type="hidden" id="diaryTypeId" name="diaryType.diaryTypeId" value="${diaryType.diaryTypeId }" />
				<table align="center">
					<tr>
						<td>类别名称：</td>
						<td><input type="text" id="typeName" name="diaryType.typeName"
